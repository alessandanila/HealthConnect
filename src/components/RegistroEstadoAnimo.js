...
import ContenidoEducativo from './ContenidoEducativo'; // Importa el nuevo componente
...
function RegistroEstadoAnimo() {
    ...
    // Nueva función para navegar a Contenido Educativo
    const handleIrContenidoEducativo = () => {
        navigate('/contenido-educativo'); // Asegúrate de que esta ruta esté configurada en tu App.js
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                <div className={styles.topButtons}> {/* Nuevo contenedor para los botones superiores */}
                    <button onClick={handleIrPerfil} className={styles.perfilButton}>
                        Mi Perfil {/* Aquí podrías mostrar un icono de perfil */}
                    </button>
                    {/* Nuevo botón de Contenido Educativo */}
                    <button onClick={handleIrContenidoEducativo} className={styles.educacionButton}>
                        Contenido Educativo
                    </button>
                </div>
